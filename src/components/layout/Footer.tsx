      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="text-white/90 font-medium text-lg">Rakesh Kumawat</p>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-xl glass-strong border border-white/10 hover:border-primary/50 transition-all duration-300 hover:-translate-y-1"
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} Rakesh Kumawat. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
